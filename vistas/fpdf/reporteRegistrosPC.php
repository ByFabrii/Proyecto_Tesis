...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE REGISTROS PARA PROTECCIÓN CIVIL"), 0, 1, 'C', 0);
      $this->Ln(3);
      ...
      $this->Cell(30, 10, utf8_decode('Temp. Actual'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('Temp. Más alta'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('Vel. del viento'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('Dir. del viento'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('Precipitación'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('Radiación solar'), 1, 1, 'C', 1);
   }
...
$significado = getWindDirection($datos_reporte->Wind_Dir);
   ...
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->Temp_Out), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->Hi_Temp), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->Wind_Speed), 1, 0, 'C', 0);
   $pdf->Cell(35, 10, utf8_decode($significado), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->Rain_Rate), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->Solar_Rad), 1, 1, 'C', 0);
}



$pdf->Output('reporteProteccionCivil.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
